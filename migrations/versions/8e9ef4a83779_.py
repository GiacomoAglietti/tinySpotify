...
Revision ID: 8e9ef4a83779
Revises: 45c7b56668d2
Create Date: 2022-09-03 17:45:08.361112
...
revision = '8e9ef4a83779'
down_revision = '45c7b56668d2'
branch_labels = None
depends_on = None
...
def downgrade():
    ...
    sa.Column('name', sa.VARCHAR(length=50), autoincrement=False, nullable=False),
    sa.Column('id_playlist', sa.INTEGER(), autoincrement=False, nullable=True),
    sa.ForeignKeyConstraint(['id_playlist'], ['playlist.id'], name='genres_id_playlist_fkey', onupdate='CASCADE', ondelete='CASCADE'),
