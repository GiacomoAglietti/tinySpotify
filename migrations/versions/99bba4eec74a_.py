...
Revision ID: 99bba4eec74a
Revises: 8e9ef4a83779
Create Date: 2022-09-03 19:52:16.760337
...
revision = '99bba4eec74a'
down_revision = '8e9ef4a83779'
branch_labels = None
depends_on = None
...
def downgrade():
    ...
    sa.ForeignKeyConstraint(['name_genre'], ['genres.name'], name='playlist_name_genre_fkey', onupdate='CASCADE', ondelete='CASCADE'),
