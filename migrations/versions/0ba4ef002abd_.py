...
Revision ID: 0ba4ef002abd
Revises: fde3f5585ce2
Create Date: 2022-08-23 21:57:51.365228
...
revision = '0ba4ef002abd'
down_revision = 'fde3f5585ce2'
branch_labels = None
depends_on = None
...
def downgrade():
    ...
    sa.ForeignKeyConstraint(['id_playlist'], ['playlist.id'], name='genres_id_playlist_fkey', ondelete='CASCADE'),
