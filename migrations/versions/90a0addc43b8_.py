...
Revision ID: 90a0addc43b8
Revises: 
Create Date: 2022-08-23 17:15:14.534785
...
def downgrade():
    ...
    sa.Column('num_in_playlist', sa.INTEGER(), autoincrement=False, nullable=True),
